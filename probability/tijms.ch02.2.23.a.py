...
"""
    Exercise 2.18 
    What is the probability that any two adjacent letters are different in a random permutation of the ten letters of the word statistics? 
...
def main():
    ...
    parser.add_argument('--word',       default='statistics',   type=str, metavar='str',        help='word to use for permutations')
